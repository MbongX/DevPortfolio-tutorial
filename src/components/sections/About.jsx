                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                    ...
                    <div className="flex flex-col gap-12">
                        <div className="flex flex-col gap-8">
                            <FadeIn delay={60}>
                                <div className="inline-flex gap-2.5 px-5 py-2.5 border border-primary/30 bp-primary/10 rounded-full w-fit">
                            ...
                            <FadeIn delay={100}>
                                <h2 className="text-4xl lg:text-5xl font-notmal text-white leading-tight">
                                ...
                                <div className="grid grid-cols-3 gap-8">
                                    {ABOUT_STATS.map((stat, index) => (
                                        <div key={index} className="relative">
                                            <div className="absolute -leftl4 top-0 w-1h-full bg-linear-to-b from primary via-primary/50 to primary/20 rounded-full"></div>
