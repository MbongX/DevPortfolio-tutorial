                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-left">
                        ...
                        <FadeIn delay={200}>
                            <p className="text-lg text-white/70 max-w-137.5 mb-8">
                                Welcome to my software developer portfolio! I'm a passionate developer with experience
                                in building modern web applications. Transforming ideas into digital transformation,
                            </p>
                        </FadeIn>
                        ...
                        <FadeIn delay={400}>
                            <div className="grid gird-col-2 md:grid-cols-4 gap-10 max-w-full">
                    ...
                    <FadeIn delay={200}>
                        <div className="relative">
                            <div className="relative overflow-hidden rounded-2x1 aspect-4/5 max-w-[500px] ml-auto group">
