...
const FadeIn = ({children, delay=0, duration=500,threshold=0.1}) => {
    ...
    //Use effect to trigger fade-in animation when the element is in view
    useEffect(() => {
        const observer = new IntersectionObserver(
            ...
            {
                threshold: threshold,
                rootMargin: '0px 0px -50px 0px' // Trigger slightly before element is fully in view/in view
            }
        );
